...
const faqs = [
  {
    question: "What is a Business Analyst course?",
    answer:
      "This course trains you in requirements gathering, data analysis, documentation, process modeling, and communication skills needed to bridge business and IT teams.",
  },
  {
    question: "Do I need prior experience in business or IT?",
    answer:
      "No prior experience is required. Basic knowledge of computers and data handling helps, and the course usually starts with fundamentals of business analysis and tools.",
  },
  {
    question: "What tools and technologies will I learn?",
    answer:
      "You will learn Excel, SQL, Tableau, Power BI, Python/R for data analysis, JIRA/Confluence for project management, and basics of business process modeling.",
  },
  {
    question: "What projects will I build during the course?",
    answer:
      "You’ll work on real-world projects like business requirement documents, data analysis reports, dashboards, process workflows, and case studies to demonstrate your skills.",
  },
  {
    question: "What career opportunities are available after this course?",
    answer:
      "You can work as a Business Analyst, Data Analyst, Functional Consultant, Project Analyst, or Requirement Engineer in IT companies, consultancies, and business organizations.",
  },
  {
    question: "Will I receive a certificate after completion?",
    answer:
      "Yes, upon successful completion, you’ll receive an industry-recognized certificate validating your business analysis and data analytics skills.",
  },
  {
    question: "Does the course include placement assistance?",
    answer:
      "Yes, many programs provide career guidance, resume building, interview preparation, and connections with hiring partners for job opportunities.",
  },
];
...
const steps = [
  {
    ...
    details:
      "Understand the role of a Business Analyst, project lifecycle, key responsibilities, and fundamentals of requirements gathering.",
  },
  {
    title: "Module 2: Requirement Elicitation & Documentation",
    details:
      "Learn techniques like interviews, surveys, workshops, and observation to gather requirements.\nDocument using BRD, FRD, and user stories effectively.",
  },
  {
    title: "Module 3: Business Process Modeling",
    details:
      "Analyze and map business processes using BPMN, flowcharts, and UML diagrams.\nIdentify bottlenecks and suggest process improvements.",
  },
  {
    title: "Module 4: Data Analysis & Visualization",
    details:
      "Work with Excel, SQL, and Python/R for data analysis.\nCreate dashboards and visual reports using Tableau or Power BI to support decision-making.",
  },
  {
    title: "Module 5: Tools & Collaboration",
    details:
      "Learn JIRA, Confluence, and Trello for project management.\nUse Git/GitHub basics for versioning documentation and collaborative work.",
  },
  {
    title: "Module 6: Agile & Scrum Fundamentals",
    details:
      "Understand Agile methodologies, Scrum roles, sprints, user stories, and backlog management for iterative project delivery.",
  },
  {
    title: "Module 7: Stakeholder Management & Communication",
    details:
      "Develop effective communication, negotiation, and presentation skills.\nLearn stakeholder analysis, conflict resolution, and reporting techniques.",
  },
  {
    title: "Module 8: Real-world Projects",
    details:
      "Work on case studies and projects like market analysis, requirement gathering for a software project, dashboard creation, and process optimization.",
  },
  {
    title: "Module 9: Career Preparation",
    details:
      "Prepare for interviews with mock sessions, resume building, portfolio creation, and tips for Business Analyst roles in IT and business organizations.",
  },
];
  return (
    <div>
      <div>
        ...
        <div className="hero-section d-flex flex-column justify-content-center align-items-center text-center text-white">
          <h3 className="fw-bold display-5">
            Advanced Certification in Business Analyst
          </h3>
        ...
        <div className="container my-5">
          <div className="row align-items-center">
            ...
            <div className="col-md-6 text-center">
              <img
                src="https://www.learntek.org/blog/wp-content/uploads/2018/03/BUSINESS.png"
        ...
        <div className="row align-items-center justify-content-center">
          ...
          <div className="col-md-6 ps-md-5">
            ...
            <p className="mt-3 text-secondary">
              ...
              <strong>Business Analyst</strong> program at{" "}
